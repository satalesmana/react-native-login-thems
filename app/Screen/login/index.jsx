...
import { View, 
    ...
    return (
        ...
        <View style={{ width: windowWidth }}>
            <View style={{ width: windowWidth, marginTop: 50, marginRight: 25 }}>
                <Image
            ...
            <View style={{ width: windowWidth }}>
                <View style={{ backgroundColor: '#CBCBCB', height: 50, flexDirection: 'row', width: '90%', alignSelf: 'center', borderRadius: 10 }}>
                    <TextInput
                ...
                <Image source={require('../../../assets/images/Rectangle 6.png')}></Image>
                    ...
                    <TouchableOpacity onPress={() => { }} style={{}}>
                        <Text style={{ color: '#6C63FF' }}>Forget password?</Text>
                    </TouchableOpacity>
                </View>


                <View>
                    <TouchableOpacity onPress={goLogin} style={{ width: '90%', alignSelf: 'center', height: 50, backgroundColor: '#6C63FF', borderRadius: 10 }}>
                        <Text style={{ marginVertical: 'auto', textAlign: 'center', fontSize: 20, color: 'white' }}>Next</Text>
                    </TouchableOpacity>
                    <View style={{flexDirection: 'row', alignSelf: 'center', marginTop: 20}}>
                        <Text>New Member?</Text>
                        <Text onPress={goLogin} style={{marginLeft: 5, backroundColor: "6C63FF"}}>Register now</Text>
                    </View>
                </View>
            </View>
        </View>
