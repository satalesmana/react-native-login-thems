    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headerTop}>
          <Image source={AI} style={styles.profileImage} />
      ...
      <View style={styles.details}>
        ...
        <View style={styles.detailItem}>
          ...
          <View style={styles.detailTextContainer}>
            <Text style={styles.detailValue}>{auth.prodi}</Text>
        ...
        <View style={styles.detailItem}>
          ...
          <View style={styles.detailTextContainer}>
            <Text style={styles.detailValue}>{auth.kelasCode}</Text>
        ...
        <View style={styles.detailItem}>
          ...
          <View style={styles.detailTextContainer}>
            <Text style={styles.detailValue}>{auth.telp}</Text>
